...
public class LSB_encode {
	...
	//static final String STEGIMAGEFILE = "D:\\2.jpg";
        ...
        public void encode(String MESSAGE, String COVERIMAGEFILE,String STEGIMAGEFILE) { 
	 
		try{
//		String contentOfMessageFile = (readMessageFile(MESSAGEFILE));
...
public static String readMessageFile (String MESSAGEFILE) throws FileNotFoundException{
...
public static void hideTheMessage (int[] bits, BufferedImage theImage,String STEGIMAGEFILE) throws Exception{
